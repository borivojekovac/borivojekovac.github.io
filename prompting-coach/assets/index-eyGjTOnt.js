...
`);m=b.pop()||"";for(const v of b){const x=v.trim();if(!(!x||x==="data: [DONE]")&&x.startsWith("data: "))try{const C=JSON.parse(x.slice(6)),k=(y=(d=C.choices)==null?void 0:d[0])==null?void 0:y.delta;k!=null&&k.content&&(yield{content:k.content,done:!1,usage:null}),C.usage&&(h={prompt:C.usage.prompt_tokens,completion:C.usage.completion_tokens,total:C.usage.total_tokens})}catch(C){console.warn("X/Grok: Failed to parse chunk",C)}}}}catch(u){throw u instanceof w?u:w.streamInterrupted(u.message)}finally{c.releaseLock()}}}S(Pe,"id","x"),S(Pe,"displayName","X (Grok)");const J={OPENAI:"openai",ANTHROPIC:"anthropic",GOOGLE:"google",X:"x"},Be={[J.OPENAI]:Ee,[J.ANTHROPIC]:ke,[J.GOOGLE]:Se,[J.X]:Pe};function on(){return Object.values(Be).map(s=>({id:s.id,name:s.displayName,models:s.getModels(),defaultModel:s.getDefaultModel()}))}function xt(s,e,t=null){const n=s==null?void 0:s.toLowerCase(),i=Be[n];if(!i)throw new w(`Unknown provider type: ${s}`,E.UNKNOWN,!1);const r=t||i.getDefaultModel();return new i(e,r)}function Je(s){const e=Be[s==null?void 0:s.toLowerCase()];return e?e.getModels():[]}const fe=on();class an extends pe{constructor(){super({title:"Settings"}),this.settings=R(),this.apiKeyInputs={}}createContent(){const e=document.createElement("div");return e.style.cssText="display: flex; flex-direction: column; gap: var(--pc-space-6);",e.appendChild(this.createThemeSection()),e.appendChild(this.createCoachingModeSection()),e.appendChild(this.createCoachLLMSection()),e.appendChild(this.createTestLLMSection()),e.appendChild(this.createApiKeysSection()),e.appendChild(this.createExportLogsSection()),e}createThemeSection(){const e=document.createElement("div"),t=document.createElement("h3");t.className="text-title",t.style.cssText="margin-bottom: var(--pc-space-3);",t.textContent="Theme",e.appendChild(t);const n=document.createElement("div");return n.style.cssText="display: flex; gap: var(--pc-space-3);",["system","light","dark"].forEach(i=>{const r=document.createElement("label");r.style.cssText=`
      ...
      `,o.addEventListener("mouseenter",()=>{o.style.background="var(--pc-surface-container)"}),o.addEventListener("mouseleave",()=>{o.style.background="transparent"});const a=document.createElement("input");a.type="radio",a.name="coachingMode",a.value=r.id,a.checked=(this.settings.coachingMode||"beginner")===r.id,a.style.cssText="margin-top: 3px;",a.addEventListener("change",()=>{this.settings.coachingMode=r.id});const l=document.createElement("div"),c=document.createElement("span");c.className="text-body",c.style.cssText="font-weight: 500;",c.textContent=r.name,l.appendChild(c);const p=document.createElement("div");p.className="text-body",p.style.cssText="font-size: 0.8rem; color: var(--pc-on-surface-variant); margin-top: 2px;",p.textContent=r.description,l.appendChild(p),o.appendChild(a),o.appendChild(l),n.appendChild(o)}),e.appendChild(n),e}createCoachLLMSection(){const e=document.createElement("div"),t=document.createElement("h3");t.className="text-title",t.style.cssText="margin-bottom: var(--pc-space-3);",t.textContent="Coach LLM",e.appendChild(t);const n=document.createElement("p");n.className="text-body",n.style.cssText="color: var(--pc-on-surface-variant); margin-bottom: var(--pc-space-2); font-size: 0.85rem;",n.textContent="Model used for prompt evaluation and feedback.",e.appendChild(n);const i=document.createElement("div");i.style.cssText="display: flex; gap: var(--pc-space-3); flex-wrap: wrap;";const r=document.createElement("div");r.style.cssText="flex: 1; min-width: 140px;";const o=document.createElement("label");o.className="text-label",o.style.cssText="display: block; margin-bottom: var(--pc-space-1); color: var(--pc-on-surface-variant);",o.textContent="Provider",r.appendChild(o),this.coachProviderSelect=document.createElement("select"),this.coachProviderSelect.className="input",this.coachProviderSelect.style.cssText="width: 100%;",fe.forEach(c=>{const p=document.createElement("option");p.value=c.id,p.textContent=c.name,this.coachProviderSelect.appendChild(p)}),this.coachProviderSelect.value=this.settings.coachProvider||"openai",this.coachProviderSelect.addEventListener("change",()=>{this.settings.coachProvider=this.coachProviderSelect.value,this.updateCoachModelOptions()}),r.appendChild(this.coachProviderSelect),i.appendChild(r);const a=document.createElement("div");a.style.cssText="flex: 2; min-width: 200px;";const l=document.createElement("label");return l.className="text-label",l.style.cssText="display: block; margin-bottom: var(--pc-space-1); color: var(--pc-on-surface-variant);",l.textContent="Model",a.appendChild(l),this.coachModelSelect=document.createElement("select"),this.coachModelSelect.className="input",this.coachModelSelect.style.cssText="width: 100%;",this.coachModelSelect.addEventListener("change",()=>{this.settings.coachModel=this.coachModelSelect.value}),a.appendChild(this.coachModelSelect),i.appendChild(a),e.appendChild(i),this.updateCoachModelOptions(),e}updateCoachModelOptions(){const e=this.coachProviderSelect.value,t=Je(e);this.coachModelSelect.innerHTML="",t.forEach(i=>{const r=document.createElement("option");r.value=i.id,r.textContent=i.name,i.description&&(r.title=i.description),this.coachModelSelect.appendChild(r)});const n=t.map(i=>i.id);this.settings.coachModel&&n.includes(this.settings.coachModel)?this.coachModelSelect.value=this.settings.coachModel:t.length>0&&(this.coachModelSelect.value=t[0].id,this.settings.coachModel=t[0].id)}createTestLLMSection(){const e=document.createElement("div"),t=document.createElement("h3");t.className="text-title",t.style.cssText="margin-bottom: var(--pc-space-3);",t.textContent="Test LLM",e.appendChild(t);const n=document.createElement("div");n.style.cssText="display: flex; gap: var(--pc-space-3); flex-wrap: wrap;";const i=document.createElement("div");i.style.cssText="flex: 1; min-width: 140px;";const r=document.createElement("label");r.className="text-label",r.style.cssText="display: block; margin-bottom: var(--pc-space-1); color: var(--pc-on-surface-variant);",r.textContent="Provider",i.appendChild(r),this.testProviderSelect=document.createElement("select"),this.testProviderSelect.className="input",this.testProviderSelect.style.cssText="width: 100%;",fe.forEach(l=>{const c=document.createElement("option");c.value=l.id,c.textContent=l.name,this.testProviderSelect.appendChild(c)}),this.testProviderSelect.value=this.settings.testProvider||"openai",this.testProviderSelect.addEventListener("change",()=>{this.settings.testProvider=this.testProviderSelect.value,this.updateModelOptions()}),i.appendChild(this.testProviderSelect),n.appendChild(i);const o=document.createElement("div");o.style.cssText="flex: 2; min-width: 200px;";const a=document.createElement("label");return a.className="text-label",a.style.cssText="display: block; margin-bottom: var(--pc-space-1); color: var(--pc-on-surface-variant);",a.textContent="Model",o.appendChild(a),this.testModelSelect=document.createElement("select"),this.testModelSelect.className="input",this.testModelSelect.style.cssText="width: 100%;",this.testModelSelect.addEventListener("change",()=>{this.settings.testModel=this.testModelSelect.value}),o.appendChild(this.testModelSelect),n.appendChild(o),e.appendChild(n),this.updateModelOptions(),e}updateModelOptions(){const e=this.testProviderSelect.value,t=Je(e);this.testModelSelect.innerHTML="",t.forEach(i=>{const r=document.createElement("option");r.value=i.id,r.textContent=i.name,i.description&&(r.title=i.description),this.testModelSelect.appendChild(r)});const n=t.map(i=>i.id);this.settings.testModel&&n.includes(this.settings.testModel)?this.testModelSelect.value=this.settings.testModel:t.length>0&&(this.testModelSelect.value=t[0].id,this.settings.testModel=t[0].id)}createApiKeysSection(){const e=document.createElement("div"),t=document.createElement("div");t.style.cssText="margin-bottom: var(--pc-space-3);";const n=document.createElement("h3");n.className="text-title",n.textContent="API Keys",t.appendChild(n);const i=document.createElement("p");i.className="text-body",i.style.cssText="color: var(--pc-on-surface-variant); margin-top: var(--pc-space-1);",i.textContent="⚠️ Keys are stored locally on your device.",t.appendChild(i),e.appendChild(t);const r=document.createElement("div");return r.style.cssText="display: flex; flex-direction: column; gap: var(--pc-space-3);",fe.forEach(o=>{const a=document.createElement("div"),l=document.createElement("label");l.className="text-label",l.style.cssText="display: block; margin-bottom: var(--pc-space-1); color: var(--pc-on-surface-variant);",l.textContent=o.name,a.appendChild(l);const c=document.createElement("input");c.type="password",c.className="input",c.placeholder=`Enter ${o.name} API key`,c.value=this.settings.apiKeys[o.id]||"",c.autocomplete="off",c.addEventListener("input",p=>{this.settings.apiKeys[o.id]=p.target.value.trim()||null}),this.apiKeyInputs[o.id]=c,a.appendChild(c),r.appendChild(a)}),e.appendChild(r),e}createExportLogsSection(){const e=document.createElement("div"),t=document.createElement("h3");t.className="text-title",t.style.cssText="margin-bottom: var(--pc-space-3);",t.textContent="Agent Logs",e.appendChild(t);const n=document.createElement("p");n.className="text-body",n.style.cssText="color: var(--pc-on-surface-variant); margin-bottom: var(--pc-space-3); font-size: 0.85rem;",n.textContent="Export all agent interactions for debugging or analysis.",e.appendChild(n);const i=document.createElement("div");i.style.cssText="display: flex; align-items: center; gap: var(--pc-space-3);";const r=document.createElement("button");return r.className="btn btn-outlined",r.style.cssText="min-height: 40px;",r.innerHTML=`
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="margin-right: var(--pc-space-2);">
        <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
      </svg>
      Export Logs
    `,r.addEventListener("click",async()=>{const o=await Re();if(o===0){f("No logs to export");return}await Ht(),f(`Exported ${o} log entries`)}),i.appendChild(r),this.logCountEl=document.createElement("span"),this.logCountEl.className="text-body",this.logCountEl.style.cssText="color: var(--pc-on-surface-variant); font-size: 0.85rem;",this.logCountEl.textContent="Loading...",i.appendChild(this.logCountEl),e.appendChild(i),this.updateLogCount(),e}async updateLogCount(){const e=await Re();this.logCountEl&&(e===0?this.logCountEl.textContent="No logs yet":this.logCountEl.textContent=`${e} log${e!==1?"s":""} stored`)}show(){this.render(),this.setContent(this.createContent()),this.addAction("Cancel",()=>this.close(),"text"),this.addAction("Save",()=>this.save(),"filled"),super.show()}save(){mt(this.settings),f("Settings saved"),this.close()}}let $=null,Ae=[];function cn(){window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),$=s,Ae.forEach(e=>e(!0))}),window.addEventListener("appinstalled",()=>{$=null,Ae.forEach(s=>s(!1))})}function He(){return $!==null}async function ln(){if(!$)return!1;$.prompt();const{outcome:s}=await $.userChoice;return $=null,s==="accepted"}function dn(s){Ae.push(s),s(He())}const Ne={"text/plain":".txt","text/markdown":".md","application/json":".json",".txt":"text/plain",".md":"text/markdown",".json":"application/json"},pn=[".txt",".md",".json"],wt=102400,hn=5e4,G={UNSUPPORTED_TYPE:"UNSUPPORTED_TYPE",SIZE_EXCEEDED:"SIZE_EXCEEDED",EMPTY_FILE:"EMPTY_FILE",READ_ERROR:"READ_ERROR"};function Fe(s){if(!s)return"";const e=s.lastIndexOf(".");return e===-1?"":s.slice(e).toLowerCase()}function mn(s){if(s.type&&Ne[s.type])return!0;const e=Fe(s.name);return pn.includes(e)}function un(s){if(s.type&&Ne[s.type])return s.type;const e=Fe(s.name);return Ne[e]||e}function fn(s,e=wt){if(!mn(s))return{valid:!1,error:`Unsupported file type: ${Fe(s.name)||s.type||"unknown"}. Supported: .txt, .md, .json`,errorCode:G.UNSUPPORTED_TYPE};if(s.size>e){const t=Math.round(e/1024);return{valid:!1,error:`File too large: ${Math.round(s.size/1024)}KB (limit: ${t}KB)`,errorCode:G.SIZE_EXCEEDED}}return s.size===0?{valid:!1,error:"File is empty",errorCode:G.EMPTY_FILE}:{valid:!0}}function yn(s){return new Promise((e,t)=>{const n=new FileReader;n.onload=()=>e(n.result),n.onerror=()=>t(new Error(`Failed to read file: ${s.name}`)),n.readAsText(s)})}function gn(s){return s<1024?`${s} B`:s<1024*1024?`${(s/1024).toFixed(1)} KB`:`${(s/(1024*1024)).toFixed(1)} MB`}class ne extends Error{constructor(e,t,n){super(e),this.name="AttachmentError",this.code=t,this.filename=n}}async function vn(s,e=wt){const t=fn(s,e);if(!t.valid)throw new ne(t.error,t.errorCode,s.name);let n;try{n=await yn(s)}catch{throw new ne(`Failed to read file: ${s.name}`,G.READ_ERROR,s.name)}if(!n||n.trim()==="")throw new ne("File is empty",G.EMPTY_FILE,s.name);const i={id:crypto.randomUUID(),filename:s.name,content:n,size:s.size,type:un(s),addedAt:new Date().toISOString()};return await T(),await A("attachments",i),i}async function he(){return await T(),(await Z("attachments")).sort((e,t)=>new Date(t.addedAt).getTime()-new Date(e.addedAt).getTime())}async function bn(s){return await T(),await j("attachments",s)?(await qe("attachments",s),!0):!1}async function re(){await T();const e=(await Z("attachments")).length;return await Dt("attachments"),e}async function Qe(s=hn){const e=await he();if(e.length===0)return{context:"",truncated:!1,count:0};const t=[];let n=0,i=!1;for(const r of e){const o=`--- Attached File: ${r.filename} ---`,a=`--- End of ${r.filename} ---`,l=o.length+a.length+4;if(n+l+r.content.length>s){const c=s-n-l-50;if(c>100){const p=r.content.slice(0,c);t.push(`${o}
${p}
[... content truncated ...]
${a}`),i=!0}break}t.push(`${o}
${r.content}
${a}`),n+=l+r.content.length}return{context:t.join(`

`),truncated:i,count:e.length}}let Le=null,Me=null,V=null;function xn(s){Le=s}function wn(s){Me=s}function Cn(s){V=s}function et(){return crypto.randomUUID()}async function $e(){const s=await N(),e=await de(),t=await _e(),n=await he(),i=s.promptText&&s.promptText.trim().length>0,r=e.length>0,o=t.length>0,a=n.length>0;return i||r||o||a}async function Tn(){var a,l;const s=await N();if(!s.restoredFromId)return!0;const e=await Et(s.restoredFromId);if(!e)return!0;const t=await de(),n=await _e(),i=(s.promptText||"")!==(e.prompt||""),r=t.length!==(((a=e.feedbackHistory)==null?void 0:a.length)||0),o=n.length!==(((l=e.results)==null?void 0:l.length)||0);return i||r||o}async function En(){const s=await N(),e=await de(),t=await _e(),n=await he(),i=s.promptText||"",r=i.substring(0,100).trim();let o=null,a=null;return e.length>0&&(o=e[0].overall,a=e[0].description),{id:s.id,createdAt:new Date(s.createdAt).getTime(),archivedAt:Date.now(),prompt:i,previewText:r||"(empty prompt)",feedbackHistory:e,results:t,attachmentIds:n.map(l=>l.id),finalScore:o,finalDescription:a,starred:!1}}async function Ct(){if(!await $e())return null;if(!await Tn())return console.log("Skipping archive: restored session has no modifications"),null;const t=await En();try{await A("sessions",t)}catch(n){throw n.name==="QuotaExceededError"||n.message&&n.message.includes("quota")?new Error("Storage quota exceeded. Please delete some old sessions from History to free up space."):n}return console.log(`Session archived: ${t.id}`),t.id}async function kn(){await vt(),await gt(),await re(),await yt(),Le&&Le()}async function Tt(s={}){const{skipConfirmation:e=!1}=s,t=await $e();return t&&!e&&V&&!await V("Start New Session?","Your current session will be saved to history. You can restore it later from the History menu.")?!1:(t&&await Ct(),await kn(),!0)}async function Sn(s={}){const{starredOnly:e=!1,searchQuery:t="",limit:n=50}=s;await T();let r=(await Z("sessions")).filter(o=>o.archivedAt);if(e&&(r=r.filter(o=>o.starred)),t.trim()){const o=t.toLowerCase();r=r.filter(a=>a.previewText&&a.previewText.toLowerCase().includes(o)||a.prompt&&a.prompt.toLowerCase().includes(o))}return r.sort((o,a)=>a.archivedAt-o.archivedAt),r=r.slice(0,n),r.map(o=>{var a,l;return{id:o.id,archivedAt:o.archivedAt,previewText:o.previewText||"(empty prompt)",finalScore:o.finalScore,starred:o.starred||!1,feedbackCount:((a=o.feedbackHistory)==null?void 0:a.length)||0,resultCount:((l=o.results)==null?void 0:l.length)||0}})}async function Et(s){await T();const e=await j("sessions",s);return e&&e.archivedAt?e:null}async function Pn(s){const e=await Et(s);if(!e)throw new Error(`Session not found: ${s}`);await $e()&&await Ct(),await vt(),await gt(),await re();const n={id:et(),createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),promptText:e.prompt||"",promptHistory:[],results:[],totalTokens:0,lastScore:e.finalScore,lastDescription:e.finalDescription,feedbackCount:0,restoredFromId:s};if(await A("sessions",n),ft(n.id),e.feedbackHistory&&e.feedbackHistory.length>0){for(const i of e.feedbackHistory){const r={...i,id:et(),sessionId:n.id};await A("feedback",r)}await _({feedbackCount:e.feedbackHistory.length,lastScore:e.finalScore,lastDescription:e.finalDescription})}e.results&&e.results.length>0&&await _({results:e.results}),Me&&Me({prompt:e.prompt,feedbackHistory:e.feedbackHistory,results:e.results,attachmentIds:e.attachmentIds,finalScore:e.finalScore,finalDescription:e.finalDescription})}async function An(s){await T();const e=await j("sessions",s);if(!e)throw new Error(`Session not found: ${s}`);return e.starred=!e.starred,await A("sessions",e),e.starred}async function Nn(s,e={}){const{skipConfirmation:t=!1}=e;return!t&&V&&!await V("Delete Session?","This session will be permanently deleted. This action cannot be undone.")?!1:(await T(),await qe("sessions",s),console.log(`Session deleted: ${s}`),!0)}class Ln extends pe{constructor(e={}){super(e),this.message=e.message||"",this.confirmLabel=e.confirmLabel||"Confirm",this.cancelLabel=e.cancelLabel||"Cancel",this.confirmVariant=e.confirmVariant||"filled",this.destructive=e.destructive||!1,this.resolvePromise=null}render(){super.render();const e=document.createElement("p");e.style.cssText=`
      color: var(--pc-on-surface-variant);
      line-height: 1.5;
      margin: 0 0 var(--pc-space-4) 0;
    `,e.textContent=this.message,this.setContent(e),this.addAction(this.cancelLabel,()=>{this.resolve(!1)},"text");const t=this.addAction(this.confirmLabel,()=>{this.resolve(!0)},this.confirmVariant);return this.destructive&&(t.style.backgroundColor="var(--pc-error, #EF4444)",t.style.color="white"),this.overlay}resolve(e){this.resolvePromise&&(this.resolvePromise(e),this.resolvePromise=null),this.close()}async prompt(){return new Promise(e=>{this.resolvePromise=e,this.show()})}close(){this.resolvePromise&&(this.resolvePromise(!1),this.resolvePromise=null),super.close()}}async function kt(s,e,t={}){return new Ln({title:s,message:e,...t}).prompt()}class Mn{constructor(e={}){this.onClose=e.onClose||null,this.onNewSession=e.onNewSession||null,this.onShowHistory=e.onShowHistory||null,this.onCopyPrompt=e.onCopyPrompt||null,this.onTogglePreview=e.onTogglePreview||null,this.isPreviewMode=!1,this.element=null,this.backdrop=null,this.isOpen=!1,Cn((t,n)=>kt(t,n))}render(){const e=document.createElement("div");e.className="menu-container",e.style.cssText="position: fixed; inset: 0; z-index: var(--pc-z-overlay); pointer-events: none;",this.backdrop=document.createElement("div"),this.backdrop.className="menu-backdrop",this.backdrop.style.cssText=`
      position: absolute;
      inset: 0;
    ...
    `;const n=document.createElement("h2");n.className="text-title-lg",n.textContent="Prompt Coach",t.appendChild(n),this.element.appendChild(t);const i=document.createElement("ul");return i.style.cssText="list-style: none; padding: var(--pc-space-2) 0; flex: 1;",[{label:"New Session",icon:"newSession",action:()=>this.handleNewSession()},{label:"Session History",icon:"sessionHistory",action:()=>this.handleShowHistory()},{separator:!0},{label:"Copy Prompt",icon:"copyPrompt",action:()=>this.handleCopyPrompt()},{label:this.isPreviewMode?"Edit Prompt":"Preview Prompt",icon:this.isPreviewMode?"editPrompt":"previewPrompt",action:()=>this.handleTogglePreview(),id:"preview-toggle-item"},{separator:!0},{label:"Settings",icon:"settings",action:()=>this.openSettings()},{label:"Install App",icon:"install",action:()=>this.handleInstall(),id:"install-item",hidden:!He()}].forEach(o=>{if(o.separator){const c=document.createElement("li");c.style.cssText=`
      ...
      `,l.innerHTML=`${I(o.icon)}<span>${o.label}</span>`,l.addEventListener("click",()=>{o.action(),this.hide()}),l.addEventListener("mouseenter",()=>{l.style.backgroundColor="var(--pc-surface-variant)"}),l.addEventListener("mouseleave",()=>{l.style.backgroundColor="transparent"}),a.appendChild(l),i.appendChild(a)}),dn(o=>{const a=document.getElementById("install-item");a&&(a.style.display=o?"block":"none")}),this.element.appendChild(i),e.appendChild(this.element),e}async handleNewSession(){try{await Tt()&&(f("New session started"),this.onNewSession&&this.onNewSession())}catch(e){console.error("Failed to start new session:",e),f(e.message||"Failed to start new session","error")}}handleShowHistory(){this.onShowHistory?this.onShowHistory():nn()}handleCopyPrompt(){this.onCopyPrompt&&this.onCopyPrompt()}handleTogglePreview(){this.isPreviewMode=!this.isPreviewMode,this.updatePreviewToggleItem(),this.onTogglePreview&&this.onTogglePreview(this.isPreviewMode)}updatePreviewToggleItem(){const e=document.getElementById("preview-toggle-item");if(e){const t=e.querySelector("button");if(t){const n=this.isPreviewMode?"Edit Prompt":"Preview Prompt",i=this.isPreviewMode?"editPrompt":"previewPrompt";t.innerHTML=`${I(i)}<span>${n}</span>`}}}setPreviewMode(e){this.isPreviewMode=e,this.updatePreviewToggleItem()}async handleInstall(){await ln()&&f("App installed successfully!")}openSettings(){new an().show()}show(){this.isOpen=!0,this.backdrop.style.opacity="1",this.backdrop.style.pointerEvents="auto",this.element.style.transform="translateX(0)",this.element.style.boxShadow="var(--pc-shadow-lg)"}hide(){this.isOpen&&(this.isOpen=!1,this.backdrop.style.opacity="0",this.backdrop.style.pointerEvents="none",this.element.style.transform="translateX(-100%)",this.element.style.boxShadow="none")}toggle(){this.isOpen?this.hide():this.show()}}const In="modulepreload",qn=function(s,e){return new URL(s,e).href},tt={},Ie=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){const o=document.getElementsByTagName("link"),a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=Promise.allSettled(t.map(c=>{if(c=qn(c,n),c in tt)return;tt[c]=!0;const p=c.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(!!n)for(let y=o.length-1;y>=0;y--){const u=o[y];if(u.href===c&&(!p||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${m}`))return;const d=document.createElement("link");if(d.rel=p?"stylesheet":In,p||(d.as="script"),d.crossOrigin="",d.href=c,l&&d.setAttribute("nonce",l),document.head.appendChild(d),p)return new Promise((y,u)=>{d.addEventListener("load",y),d.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return i.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})},ye="promptcoach_skipped_principles",oe={get(){try{return JSON.parse(sessionStorage.getItem(ye)||"[]")}catch{return[]}},add(s){const e=this.get();return e.includes(s)||(e.push(s),sessionStorage.setItem(ye,JSON.stringify(e))),e},has(s){return this.get().includes(s)},clear(){sessionStorage.removeItem(ye)},count(){return this.get().length}};function D(s){const e={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return s.replace(/[&<>"']/g,t=>e[t])}function se(s,e,t,n){const i=[];let r=e;for(;r<s.length;){const o=s[r];if(o.trim()==="")break;const a=o.match(/^(\s*)/);if((a?a[1].length:0)<t&&i.length>0)break;const c=o.match(/^(\s*)[\*\-]\s+(.+)$/),p=o.match(/^(\s*)\d+\.\s+(.+)$/);if(c&&c[1].length===t){const h={content:c[2],children:null,childType:null};if(r+1<s.length){const d=s[r+1],y=d.match(/^(\s*)/),u=y?y[1].length:0,g=d.match(/^(\s*)[\*\-]\s+/),b=d.match(/^(\s*)\d+\.\s+/);if((g||b)&&u>t){const v=g?"ul":"ol",x=se(s,r+1,u);h.children=x.items,h.childType=v,r=x.endIdx}else r++}else r++;i.push(h)}else if(p&&p[1].length===t){const h={content:p[2],children:null,childType:null};if(r+1<s.length){const d=s[r+1],y=d.match(/^(\s*)/),u=y?y[1].length:0,g=d.match(/^(\s*)[\*\-]\s+/),b=d.match(/^(\s*)\d+\.\s+/);if((g||b)&&u>t){const v=g?"ul":"ol",x=se(s,r+1,u);h.children=x.items,h.childType=v,r=x.endIdx}else r++}else r++;i.push(h)}else if((c||p)&&(c?c[1].length:p[1].length)>t){const m=c?c[1].length:p[1].length,h=c?"ul":"ol",d=se(s,r,m);i.length>0&&(i[i.length-1].children=d.items,i[i.length-1].childType=h),r=d.endIdx}else break}return{items:i,endIdx:r}}function St(s,e){const t=e,n=s.map(i=>{let r=`<li>${O(D(i.content))}`;return i.children&&i.children.length>0&&(r+=St(i.children,i.childType||e)),r+="</li>",r}).join("");return`<${t}>${n}</${t}>`}function _n(s,e){if(e>=s.length)return null;const t=s[e];if(!t.includes("|"))return null;const n=t.split("|").map(a=>a.trim()).filter(a=>a);if(e+1>=s.length||!s[e+1].match(/^\|?[\s\-:|]+\|?$/))return null;const r=[];let o=e+2;for(;o<s.length;){const a=s[o];if(!a.includes("|")||a.trim()==="")break;const l=a.split("|").map(c=>c.trim()).filter(c=>c!=="");r.push(l),o++}return{table:{headers:n,rows:r},endIdx:o}}function W(s){if(!s||typeof s!="string")return"";const e=s.split(`
`),t=[];let n=[],i=!1,r="",o=0,a=[];for(let c=0;c<e.length;c++){const p=e[c],m=p.trim();if(m.startsWith("```"))if(i)if(m.length>3){o++,n.push(p);continue}else if(o>0){o--,n.push(p);continue}else{t.push({type:"code",lang:r,content:n.join(`
`)}),n=[],i=!1,r="";continue}else{n.length>0&&(t.push({type:"paragraph",content:n.join(`
`)}),n=[]),a.length>0&&(t.push({type:"blockquote",content:a.join(`
`)}),a=[]),i=!0,r=m.slice(3).trim(),o=0;continue}if(i){n.push(p);continue}const d=p.match(/^(#{1,6})\s+(.+)$/);if(d){n.length>0&&(t.push({type:"paragraph",content:n.join(`
`)}),n=[]),a.length>0&&(t.push({type:"blockquote",content:a.join(`
...
`)}),n=[]),a.length>0&&(t.push({type:"blockquote",content:a.join(`
`)}),a=[]);const b=_n(e,c);if(b){t.push({type:"table",...b.table}),c=b.endIdx-1;continue}}const y=p.match(/^(\s*)[\*\-]\s+(.+)$/),u=p.match(/^(\s*)\d+\.\s+(.+)$/);if(y||u){n.length>0&&(t.push({type:"paragraph",content:n.join(`
`)}),n=[]),a.length>0&&(t.push({type:"blockquote",content:a.join(`
`)}),a=[]);const b=y?y[1].length:u[1].length,v=y?"ul":"ol",x=se(e,c,b);t.push({type:"list",listType:v,items:x.items}),c=x.endIdx-1;continue}if(p.match(/^---+$/)){n.length>0&&(t.push({type:"paragraph",content:n.join(`
`)}),n=[]),a.length>0&&(t.push({type:"blockquote",content:a.join(`
`)}),a=[]),t.push({type:"hr"});continue}const g=p.match(/^>\s*(.*)$/);if(g){n.length>0&&(t.push({type:"paragraph",content:n.join(`
`)}),n=[]),a.push(g[1]);continue}if(a.length>0&&(t.push({type:"blockquote",content:a.join(`
...
`)}),t.map(c=>{switch(c.type){case"header":return`<h${c.level}>${O(D(c.content))}</h${c.level}>`;case"paragraph":const p=O(D(c.content));return p?`<p>${p}</p>`:"";case"empty":return'<p class="empty-line">&nbsp;</p>';case"list":return St(c.items,c.listType);case"table":return Bn(c.headers,c.rows);case"code":return`<pre><code class="language-${c.lang}">${D(c.content)}</code></pre>`;case"blockquote":return`<blockquote>${O(D(c.content))}</blockquote>`;case"hr":return"<hr>";default:return""}}).filter(Boolean).join("")}function Bn(s,e){const t=s.map(i=>`<th>${O(D(i))}</th>`).join(""),n=e.map(i=>`<tr>${i.map(o=>`<td>${O(D(o))}</td>`).join("")}</tr>`).join("");return`<table><thead><tr>${t}</tr></thead><tbody>${n}</tbody></table>`}function O(s){let e=s;return e=e.replace(/`([^`]+)`/g,"<code>$1</code>"),e=e.replace(/\*\*\*(.+?)\*\*\*/g,"<strong><em>$1</em></strong>"),e=e.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*(.+?)\*/g,"<em>$1</em>"),e=e.replace(/___(.+?)___/g,"<strong><em>$1</em></strong>"),e=e.replace(/__(.+?)__/g,"<strong>$1</strong>"),e=e.replace(/_(.+?)_/g,"<em>$1</em>"),e=e.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,'<img src="$2" alt="$1" style="max-width: 100%;">'),e=e.replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" target="_blank" rel="noopener">$1</a>'),e}let Q=null;async function Hn(){if(Q)return Q;try{return Q=(await Ie(()=>import("./principles-Nr9ahyFn.js"),[],import.meta.url)).default,Q}catch(s){return console.warn("Could not load principles for tooltips:",s),null}}function Fn(s){return s?s.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}class $n{constructor(e={}){this.element=null,this.backdrop=null,this.contentEl=null,this.feedbackEntry=null,this.isVisible=!1,this.isPinned=!1,this.isLoading=!1,this.isStreaming=!1,this.streamedText="",this.rawBuffer="",this.inFeedbackField=!1,this.feedbackFieldComplete=!1,this.ratio=.3,this.onClose=e.onClose||null,this.onPin=e.onPin||null,this.onSkipContinue=e.onSkipContinue||null,this.onNewSession=e.onNewSession||null,this.skipBtn=null,this.gotItBtn=null,this.streamingContainer=null}render(){this.backdrop=document.createElement("div"),this.backdrop.className="feedback-backdrop",this.backdrop.style.cssText=`
    ...
    `,e.appendChild(t);let n=!1,i=0,r=0;const o=c=>{n=!0,i=c.clientY,r=this.ratio,document.body.style.cursor="ns-resize",document.body.style.userSelect="none",c.preventDefault()},a=c=>{if(!n)return;const m=(c.clientY-i)/window.innerHeight;this.setRatio(r+m)},l=()=>{n&&(n=!1,document.body.style.cursor="",document.body.style.userSelect="")};return e.addEventListener("mousedown",o),document.addEventListener("mousemove",a),document.addEventListener("mouseup",l),e.addEventListener("touchstart",c=>{n=!0,i=c.touches[0].clientY,r=this.ratio,c.preventDefault()}),document.addEventListener("touchmove",c=>{if(!n)return;const m=(c.touches[0].clientY-i)/window.innerHeight;this.setRatio(r+m)}),document.addEventListener("touchend",()=>{n=!1}),e}createHeader(){const e=document.createElement("div");e.className="feedback-header",e.style.cssText=`
      display: flex;
      align-items: center;
...
`).replace(/\\t/g,"	").replace(/\\"/g,'"').replace(/\\\\/g,"\\")}return this.streamedText=t,t}return""}finalizeStreaming(e){this.isStreaming=!1,this.streamedText="",this.feedbackEntry=e,this.renderContent(e),this.updateFooterForComplete(e.complete,e.isHistorical),this.updateFooterForStreaming(!1)}renderStreamingContent(){this.contentEl.innerHTML="";const e=document.createElement("div");e.className="feedback-summary",e.style.cssText=`
    ...
    `;const i=e.overall,r=i>=80?"var(--pc-primary)":i>=60?"#F59E0B":"#EF4444",o=document.createElement("div");o.style.cssText=`
      min-width: 48px;
      width: 48px;
      height: 48px;
      flex-shrink: 0;
...
[COACHING_MODE: beginner - User may be new to prompting. Explain concepts thoroughly, connect to how AI works, and provide detailed examples.]`,a){const g=this.buildIterationContext(a,e);h=`${h}

${g}`}for await(const g of this.provider.streamCompletion(h,{maxTokens:1024,temperature:.3,systemPrompt:l}))g.content&&(m+=g.content);const d=Math.round(performance.now()-c),y=this.parseResponse(m),u=st(y,this.methodology);if(!u.valid)throw new Error(`Invalid response: ${u.errors.join(", ")}`);return await be(this.provider.getProviderName(),this.provider.getModelName(),m.length,null,d),y}catch(h){const d=Math.round(performance.now()-c);throw await ie(this.provider.getProviderName(),this.provider.getModelName(),h.message||"Unknown error",d),h}}async*evaluateStreaming(e,t=[],n={}){const{attachmentContext:i="",attachmentsTruncated:r=!1,coachingMode:o="beginner",previousFeedback:a=null}=n,l=await this.buildSystemPrompt(),c=performance.now();let p=e.length;i&&(p+=i.length),await ve(this.provider.getProviderName(),this.provider.getModelName(),p);let m="";try{let h=e;if(i&&(h=`[ATTACHED CONTEXT${r?" (truncated)":""}]
${i}
[END ATTACHED CONTEXT]
...
`,i&&n.promptSnapshot){const o=n.promptSnapshot.length>200?n.promptSnapshot.substring(0,200)+"...":n.promptSnapshot;r+=`Previous prompt preview: "${o}"
`}return r+=`
...
${e}`,l={count:y,truncated:d},d&&f("Attachments truncated due to size limit","warning"))}catch(h){console.warn("Failed to get attachment context:",h)}this.isTestRunning=!0,this.testBtn&&(this.testBtn.disabled=!0,this.setButtonLoading(this.testBtn,!0)),await Ze(e);const c=jt({promptSnapshot:e,provider:o.getProviderName(),model:o.getModelName(),status:"streaming"});await Ce(c),this.historyTab&&this.historyTab.addEntry(c),this.onSwitchToHistory&&this.onSwitchToHistory();const p=performance.now();let m="";await ve(o.getProviderName(),o.getModelName(),a.length);try{for await(const h of o.streamCompletion(a))if(h.content&&(m+=h.content,this.historyTab&&this.historyTab.updateExpandedEntry(c.id,{responseText:m})),h.done&&h.usage){const d=Math.round(performance.now()-p);await je(c.id,{responseText:m,tokens:h.usage,durationMs:d,status:"complete"}),this.historyTab&&this.historyTab.updateExpandedEntry(c.id,{responseText:m,tokens:h.usage,durationMs:d,status:"complete"}),await be(o.getProviderName(),o.getModelName(),m.length,h.usage,d)}}catch(h){const d=Math.round(performance.now()-p),y=h instanceof w?h.userMessage:h.message||"Unknown error";await je(c.id,{responseText:m,error:y,durationMs:d,status:"error"}),this.historyTab&&this.historyTab.updateExpandedEntry(c.id,{responseText:m,error:y,durationMs:d,status:"error"}),await ie(o.getProviderName(),o.getModelName(),y,d),f(y)}finally{this.isTestRunning=!1,this.testBtn&&(this.testBtn.disabled=!1,this.setButtonLoading(this.testBtn,!1))}}setOnSwitchToResults(e){this.onSwitchToResults=e}setResultsTab(e){this.resultsTab=e}setOnShowFeedback(e){this.onShowFeedback=e}setHistoryTab(e){this.historyTab=e}setOnSwitchToHistory(e){this.onSwitchToHistory=e}async runCoach(){if(this.isCoachRunning){f("Coach evaluation in progress");return}const e=this.promptText.trim();if(!e){f("Please enter a prompt first");return}if(!we()){f("Please configure an API key in Settings");return}const t=R(),n=t.coachProvider||"openai",i=t.apiKeys[n],r=t.coachModel||null;if(!i){f(`No API key configured for ${n}`);return}let o="",a=!1;try{const{context:c,truncated:p}=await Qe();o=c,a=p,p&&f("Attachments truncated due to size limit","warning")}catch(c){console.warn("Failed to get attachment context:",c)}this.isCoachRunning=!0,this.coachBtn&&(this.coachBtn.disabled=!0,this.setButtonLoading(this.coachBtn,!0));const l=performance.now();try{const c=new Dn(n,i,r),p=oe.get(),m=await de(),h=m.length>0?m[0]:null;this.onShowFeedbackStreaming&&this.onShowFeedbackStreaming({provider:c.getProviderName(),model:c.getModelName()});let d=null,y=0;for await(const b of c.evaluateStreaming(e,p,{attachmentContext:o,attachmentsTruncated:a,coachingMode:t.coachingMode||"beginner",previousFeedback:h}))b.type==="chunk"?this.onFeedbackStreamChunk&&this.onFeedbackStreamChunk(b.content):b.type==="complete"&&(d=b.response,y=b.durationMs);if(!d)throw new Error("No response received from coach");await Ze(e);const u=Ot({promptSnapshot:e,scores:d.scores,overall:d.overall,description:d.description,feedback:d.feedback,provider:c.getProviderName(),model:c.getModelName(),durationMs:y,targetPrinciple:d.targetPrinciple,complete:d.complete});await Gt(u);const g=zt({promptSnapshot:e,scores:d.scores,overall:d.overall,description:d.description,feedback:d.feedback,provider:c.getProviderName(),model:c.getModelName(),durationMs:y,targetPrinciple:d.targetPrinciple,complete:d.complete});await Ce(g),this.historyTab&&this.historyTab.addEntry(g),this.onFinalizeFeedbackStreaming&&this.onFinalizeFeedbackStreaming(u),console.log("Coach: Evaluation complete",u)}catch(c){const p=c.message||"Coach evaluation failed";f(p),console.error("Coach: Error",c),this.onHideFeedbackPanel&&this.onHideFeedbackPanel(),await ie(t.coachProvider||"openai",t.coachModel||"unknown",p,Math.round(performance.now()-l))}finally{this.isCoachRunning=!1,this.coachBtn&&(this.coachBtn.disabled=!1,this.setButtonLoading(this.coachBtn,!1))}}setButtonLoading(e,t){if(!document.getElementById("btn-spinner-styles")){const r=document.createElement("style");r.id="btn-spinner-styles",r.textContent=`
    ...
    `,e.innerHTML=Zn[this.entry.type]||"",e}_createContentArea(){const e=document.createElement("div");e.className="history-item-content",e.style.cssText="flex:1;min-width:0;";const t=document.createElement("div");t.className="history-item-title",t.style.cssText="font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;";const n=document.createElement("div");switch(n.className="history-item-subtitle",n.style.cssText="font-size:0.75rem;color:var(--pc-text-secondary);margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;",this.entry.type){case"feedback":this._renderFeedbackContent(t,n);break;case"result":this._renderResultContent(t,n);break;case"prompt-change":this._renderPromptChangeContent(t,n);break}return e.appendChild(t),e.appendChild(n),e}_renderFeedbackContent(e,t){const n=document.createElement("span");n.className="score-badge",n.style.cssText=`
      ...
      color: white;
    `,n.textContent=`${this.entry.overall}%`,e.appendChild(n),e.appendChild(document.createTextNode(this.entry.description||"Coach Feedback")),t.textContent=`${this.entry.provider}/${this.entry.model}`}_renderResultContent(e,t){var o;const n=document.createElement("span");n.className="status-indicator",n.style.cssText=`
    ...
    `,t.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>',t.addEventListener("click",()=>{var o;return(o=this.onClose)==null?void 0:o.call(this)}),t.addEventListener("mouseenter",()=>{t.style.background="var(--pc-surface-hover)"}),t.addEventListener("mouseleave",()=>{t.style.background="none"}),e.appendChild(t);const n=document.createElement("span");n.className="expanded-title",n.style.cssText="font-weight:500;flex:1;",n.textContent=at[this.entry.type]||"History Entry",e.appendChild(n);const i=this._createHeaderActions();i&&e.appendChild(i);const r=document.createElement("span");return r.className="expanded-timestamp",r.style.cssText="font-size:0.75rem;color:var(--pc-text-secondary);",r.textContent=this._formatTimestamp(this.entry.timestamp),e.appendChild(r),e}_createHeaderActions(){var t;const e=document.createElement("div");if(e.className="expanded-actions",e.style.cssText="display:flex;align-items:center;gap:var(--pc-space-2);",this.entry.type==="feedback"){const n=document.createElement("span");if(n.className="score-badge",n.style.cssText=`
        display: inline-flex;
        align-items: center;
        justify-content: center;
        min-width: 48px;
    ...
    `,this.entry.provider&&this.entry.model){const n=this._createStatItem("Model",`${this.entry.provider}/${this.entry.model}`);e.appendChild(n)}if(this.entry.durationMs){const n=this._createStatItem("Duration",`${(this.entry.durationMs/1e3).toFixed(1)}s`);e.appendChild(n)}const t=this._createStatItem("Score",`${this.entry.overall}%`);if(t.querySelector(".stat-value").style.color=this._getScoreColor(this.entry.overall),t.querySelector(".stat-value").style.fontWeight="600",e.appendChild(t),this.entry.description){const n=this._createStatItem("Quality",this.entry.description);e.appendChild(n)}if(this.entry.targetPrinciple){const n=this._createStatItem("Focus",this.entry.targetPrinciple);e.appendChild(n)}return e}_createStatItem(e,t){const n=document.createElement("div");n.className="stat-item",n.style.cssText="display:flex;flex-direction:column;";const i=document.createElement("span");i.className="stat-label",i.style.cssText="font-size:0.75rem;color:var(--pc-text-secondary);",i.textContent=e;const r=document.createElement("span");return r.className="stat-value",r.textContent=t,n.appendChild(i),n.appendChild(r),n}_createScoresSection(){const e=document.createElement("div");e.className="feedback-scores-section";const t=document.createElement("button");t.className="scores-collapse-header",t.setAttribute("aria-expanded","false"),t.style.cssText=`
      ...
      text-align: left;
      font-family: inherit;
    `;const n=document.createElement("h3");n.style.cssText="font-size:1rem;font-weight:500;margin:0;color:var(--pc-on-surface);",n.textContent="Principle Scores";const i=document.createElement("span");i.style.cssText="font-size:0.875rem;color:var(--pc-text-secondary);",i.textContent=`(${this.entry.scores.length})`;const r=document.createElement("span");r.className="collapse-chevron",r.innerHTML='<svg width="20" height="20" viewBox="0 -960 960 960" fill="currentColor"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>',r.style.cssText="display:flex;transition:transform 0.2s ease;transform:rotate(-90deg);margin-left:auto;",t.appendChild(n),t.appendChild(i),t.appendChild(r),e.appendChild(t);const o=document.createElement("div");o.className="scores-collapse-content",o.style.cssText="display:none;margin-top:var(--pc-space-2);";const a=document.createElement("div");return a.style.cssText="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:var(--pc-space-2);",this.entry.scores.forEach(l=>{const c=this._createScoreCard(l);a.appendChild(c)}),o.appendChild(a),e.appendChild(o),t.addEventListener("click",()=>{const l=t.getAttribute("aria-expanded")==="true";t.setAttribute("aria-expanded",(!l).toString()),o.style.display=l?"none":"block",r.style.transform=l?"rotate(-90deg)":"rotate(0deg)"}),e}_createScoreCard(e){const t=document.createElement("div");t.className="score-card",t.style.cssText=`
      display: flex;
      align-items: center;
      gap: var(--pc-space-2);
...
`).length)||0,l=this._createStatItem("Lines",a.toLocaleString());return e.appendChild(l),e}_createStatItem(e,t){const n=document.createElement("div");n.className="stat-item",n.style.cssText="display:flex;flex-direction:column;";const i=document.createElement("span");i.className="stat-label",i.style.cssText="font-size:0.75rem;color:var(--pc-text-secondary);",i.textContent=e;const r=document.createElement("span");return r.className="stat-value",r.textContent=t,n.appendChild(i),n.appendChild(r),n}_createActionsBar(){const e=document.createElement("div");e.className="prompt-change-actions-bar",e.style.cssText="display:flex;gap:var(--pc-space-2);";const t=this._createActionButton("Copy Prompt","copy",()=>this._copyPrompt());return e.appendChild(t),e}_createActionButton(e,t,n){const i=document.createElement("button");i.className="action-btn",i.style.cssText=`
    ...
    `,r.textContent=e.previewText,i.appendChild(r);const o=document.createElement("div");o.style.cssText=`
      font-size: 0.75rem;
      color: var(--pc-on-surface-variant);
      display: flex;
      flex-wrap: wrap;
      gap: var(--pc-space-2);
    `;const a=new Date(e.archivedAt),l=a.toLocaleDateString(void 0,{month:"short",day:"numeric",year:a.getFullYear()!==new Date().getFullYear()?"numeric":void 0}),c=[];if(c.push(l),e.feedbackCount>0&&c.push(`${e.feedbackCount} review${e.feedbackCount!==1?"s":""}`),e.resultCount>0&&c.push(`${e.resultCount} test${e.resultCount!==1?"s":""}`),o.textContent=c.join(" • "),i.appendChild(o),t.appendChild(i),e.finalScore!==null&&e.finalScore!==void 0){const d=document.createElement("div"),y=e.finalScore>=80?"var(--pc-primary)":e.finalScore>=60?"#F59E0B":"#EF4444";d.style.cssText=`
        min-width: 32px;
        height: 32px;
        border-radius: 50%;
        background: ${y};
    ...
    `,this.providerSelect=r,n.appendChild(i),n.appendChild(r),e.appendChild(n);const o=document.createElement("div");o.style.cssText="margin-bottom: var(--pc-space-4);";const a=document.createElement("label");a.className="text-label",a.style.cssText="display: block; margin-bottom: var(--pc-space-2); color: var(--pc-on-surface-variant);",a.textContent="API Key";const l=document.createElement("input");return l.type="password",l.className="input",l.placeholder="Enter your API key",l.autocomplete="off",this.keyInput=l,o.appendChild(a),o.appendChild(l),e.appendChild(o),e}show(){this.render(),this.setContent(this.createContent()),this.addAction("Skip",()=>this.close(),"text"),this.addAction("Save",()=>this.save(),"filled"),super.show(),setTimeout(()=>{this.keyInput.focus()},100)}save(){const e=this.providerSelect.value,t=this.keyInput.value.trim();if(!t){f("Please enter an API key");return}ut("apiKeys",{[e]:t}),f("API key saved"),this.close()}}function ts(){const s=document.getElementById("loader");if(!s)return;s.style.pointerEvents="none";const e=2e3,t=2e3,n=performance.now(),i=h=>h===1?1:1-Math.pow(2,-10*h),r=Math.random()*Math.PI*2,o=Math.random()*Math.PI*2,a=.25+Math.random()*.125,l=.1875+Math.random()*.125,c=60,p=48;function m(h){const d=h-n,y=Math.min(d/e,1),u=Math.min(d/t,1),g=d/2e3*Math.PI*2,b=50+Math.sin(g*a+r)*c*(1-u),v=50+Math.cos(g*l+o)*p*(1-u),x=1-u,k=20*(1-i(y));s.style.backdropFilter=`blur(${k}px)`,s.style.webkitBackdropFilter=`blur(${k}px)`,s.style.background=`radial-gradient(
      circle at ${b}% ${v}%,
      transparent 0%,
